...
const Settings = () => {
    ...
    useEffect(() => {
        const fetchUserProfile = async () => {
            try {
                ...
                // Assuming notification and app preferences are part of the user profile object
    ...
    const handleSavePreferences = async (e) => {
        e.preventDefault();
        try {
            // Assuming preferences are updated via the same user profile endpoint
            const updatedPreferences = {
                ...profileSettings, // Include profile settings to be updated along with preferences
                preferences: { // Nest preferences under a 'preferences' key
                    ...notificationPreferences,
                    ...appPreferences,
                },
            };
